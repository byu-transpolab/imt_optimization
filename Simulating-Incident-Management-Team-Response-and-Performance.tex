...
and excess user costs. Skabardonis et al. (1998) found that, on average,
total incident RT was 15 minutes longer when California Highway Patrol
(CHP) responded without the support of IMT. Using a system to assign a
cost per traveler per unit of time to vehicles in the observed area, the
...
size of IMT units is the metric by which the system is judged. The
studies of Ozbay et al. (2013) and Lou et al. (2011) optimize IMT units
based on RT and response rates, and the majority of studies regarding
IMT effectiveness focus on the FHWA measures of RCT, RT, and ECU.
However, some researchers have felt that other metrics proved helpful in
specific scenarios. Kim et al. (2012) utilized assumed values of fuel
price and pollution externalities from prior studies to quantify the
time and environmental costs of traffic delays, subsequently providing
recommendations to the Maryland DOT on IMT resource allocations, taking
into account the statistical likelihood of incidents in specific areas,
their projected impact, and the operational benefits of incident
management.
...
functions, or similar stand-alone efforts. While these efforts provide
