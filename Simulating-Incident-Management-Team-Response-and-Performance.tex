...
occurrence of an incident. The optimal IMT vehicle for the situation is
...
triggers an NCE that restores 25\% of the capacity gap on the affected
link, with the capacity gap defined as the difference between a link's
full and reduced capacity during an incident. In situations requiring
the response of multiple IMT units, each arriving team contributes to
restoring an additional 25\% of the existing capacity gap.
...
critical role of IMT, showcasing their ability to alleviate the impacts
of incidents on network traffic flow.
