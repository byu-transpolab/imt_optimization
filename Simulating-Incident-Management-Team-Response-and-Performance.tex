...
with 18 incidents. Figure~\ref{fig-Inc_Sample} visually represents the
...
\caption{\label{fig-Inc_Sample}Incident sampling distributions.}
...
\caption{\label{fig-Cap_Restore}IMT capacity restoration upon arrival.}
