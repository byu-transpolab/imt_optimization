...
affected link(s) (link refID), the type of change (free-flow speed,
lanes, or capacity), and the value of the change.

\hypertarget{sec-imt_response}{%
\subsection{IMT Response}\label{sec-imt_response}}
