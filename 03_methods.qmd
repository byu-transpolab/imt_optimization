...
Building on the core principles discussed in sections 2.1 and 2.2 of the literature review, this methodology section delves into the practical aspects of analyzing the impacts of incidents and Incident Management Team (IMT) vehicle responses on the network and its agents. The section focuses on three primary considerations. The first, "IMT Vehicle Configuration and Incident Selection," addresses the determination of variables such as the size of the IMT fleet, their starting locations and schedules, and the specifics of incident locations and severity, all of which can significantly impact network performance measures. Following this, "MATSim Functionality" explores the representation of these variables within the MATSim network, aiming to authentically mirror real-world conditions and accurately reflect agent behavior. Lastly, "Scenario Simulations and Comparisons" describes the various scenarios that were simulated, detailing the criteria and methodologies employed in their comparative analysis. Together, these sections provide a comprehensive overview of the approach taken to assess the network's responsiveness and efficiency under varying conditions of incident and IMT vehicle interaction.

## IMT Vehicle Configuration and Incident Selection

The location and fleet sizes of Incident Management Teams (IMTs) play crucial roles in determining vehicle response times, a relationship explored by @lou2011 and @pal2002. Additionally, @schultz2019 highlighted a significant correlation between response time (RT) and roadway clearance time (RCT). In the 'IMT Vehicle Setup' section, we organize the IMT vehicle setups thoughtfully, taking these factors into account and adhering to recommendations from Utah Highway Patrol officials regarding this project.
