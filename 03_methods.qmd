...
This section outlines the methods used for the Utah Incident Management Team Optimization model, building upon the main concepts discussed in [IMT Optimization](#sec-lit_imt_opt) and [Incident Modeling](#sec-lit_inc_mod) sections of the [Literature Review](#sec-literature). The primary goal of the model is to demonstrate the impact of traffic incidents on overall traffic delay and assess the effectiveness of IMT within a simulated environment.
