...
The study utilized the MATSim model to conduct 20 simulations across three different scenarios: "Incidents", "Current", and "Increased". Within the "Incidents" scenario, a random subset of incidents was produced without any subsequent intervention from incident management teams (IMTs). The "Current" scenario included incidents paired with responsive measures from UDOT's existing fleet of 20 IMT vehicles. The "Increased" scenario is similar to the "Current" framework, but was equip with an additional grouping of 10 IMT vehicles, for a total of 30 vehicles.

These scenarios were compared internally as well as against a "Baseline" scenario devoid of any incidents or IMT presence. Cumulatively, 61 simulation scenarios were executed, each subjected to 450 MATSim iterations. This iterative approach ensured that a majority of scenarios gravitated towards a state where travel plans displayed minimal variance between successive iterations, effectively achieving an equilibrium in travel behavior by the simulation's conclusion.
...
One of the principal metrics utilized to analyze the simulation scenarios is total vehicle hours of delay (VHD). The analysis of VHD was divided into three tiers of investigation. First, the delay within the overarching network (termed "All Links"). Second, the delay on links MATSim categorizes as motorway links --- often referred to as freeways and highways in other transportation contexts. Lastly, the specific links where incidents occur, in addition to the two immediate upstream links. This cluster of links is labeled "Impact Links" for the purposes of this study.

Overall, it is apparent that the IMT vehicles' influence within the simulations is most apparent at the "Impact Link" level. However, their effects permeate every tier of analysis. While the outcomes of certain scenarios align with anticipated projections, others deviate from intuitive or assumed results. The subsequent analysis will commence with an exploration of the "All Links" scenarios.
